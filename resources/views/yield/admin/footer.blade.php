    ...
    <div class="container footer-container mt-5 pt-3">
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 my-5 py-5">
            ...
            <div class="col-md-2 offset-md-1">
                <h5 class="py-3">features</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-3"><a href="#" class="nav-link fw-normal p-0">Upload photo</a></li>
                    <li class="nav-item mb-3"><a href="#" class="nav-link fw-normal p-0">like & comment</a></li>
                    <li class="nav-item mb-3"><a href="#" class="nav-link fw-normal p-0">download</a></li>
                </ul>
            </div>

            <div class="col-md-2">
                <h5 class="py-3">Links</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-3"><a href="{{ route('admin.home') }}" class="nav-link fw-normal p-0">Contents</a></li>
                    <li class="nav-item mb-3"><a href="{{ route('admin.user') }}" class="nav-link fw-normal p-0">Users</a></li>
                </ul>
            </div>
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-2 pt-4">
            <div class="col-md-6 d-flex align-items-center">
                <p>© 2024 Web media - All rights reserved</p>
            </div>
